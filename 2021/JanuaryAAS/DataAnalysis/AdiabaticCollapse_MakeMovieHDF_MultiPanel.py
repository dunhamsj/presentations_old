...
RootPath = HOME + 'Desktop/JanuaryAAS/Data/AdiabaticCollapse_CFA/'
suffix = ''
...
FigTitle = 'GR-CFA Adiabatic Collapse'
...
time_text = axs[0,0].text( 8.0e2, 5.0e14, '' )
...
axs[1,0].legend( loc = 4, prop = {'size':8} )
...
SaveFileAs = '../Movies/AdiabaticCollapse_MultiPanel.mp4'
